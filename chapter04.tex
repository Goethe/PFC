...
Como consecuencia de la reflexión, una señal distinta de la emitida por el transductor en origen regresa a éste. Por tanto, se produce en la cara del transductor que da al material una presión variable con el tiempo $p_R(z, t)$, constituida por la suma de la presión que se produce en cada punto de la mencionada superficie.
...
Del mismo modo, una parte de la onda que incide sobre el reflector es transmitida. Dicha onda debe atravesar el medio restante hasta alcanzar el otro extremo del material, en el camino pueden producirse más reflexiones. Si la técnica empleada es de transmisión, se produce, en ese caso, una presión en la superficie del transductor en recepción. Esta presión es similar a la que detecta el primer transductor, $p_R(z, t)$, pero está relacionada con la función de refracción asociada al cuerpo reflector.

\begin{equation}
	p_T(z, t) = p(z, t)\otimes h_t(t)\otimes h_m(z, t)
	\label{eq:potencia-recibida-transmision}
\end{equation}

\cbend{}


Finalmente, la presión $p_R$, $p_T$, se traduce en una señal eléctrica en bornes del transductor. Esta señal está relacionada con la respuesta impulsiva del transductor en recepción, $h_{tr}(t)$, que depende, al igual que $h_{te}(t)$ del circuito acondicionador y del proceso de fabricación del transductor.
...
Por consiguiente el proceso de emisión"=recepción en el que se fundamentan los \textsc{endus} puede considerarse como la respuesta impulsional en cascada de todos los fenómenos descritos.
...
La figura --- muestra un diagrama de bloques que representa el proceso de emisión"=recepción y todos los fenómenos que en el intervienen según el modelo empleado en este documento. La función de transferencia del sistema puede obtenerse de modo sencillo aplicando el teorema de la convolución. Aprovechando la linealidad del sistema se agrupan los términos de la función de transferencia en \vref{eq:funcion-transferencia-agrupada}, para que el resultado quede en función de la respuesta electromecánica del transductor $X(\omega)$ y de la respuesta espacial al impulso $H(z, \omega)$.
