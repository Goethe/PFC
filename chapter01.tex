...
Para la interacción con dispositivos externos, la \kpci{} dispone de dos conectores formato mini-D de 36 terminales que cumplen con el estándar \textsc{ieee} 1284 de protocolos de comunicación en paralelo. Situados en su parte posterior, y tal y como habitualmente sucede con los dispositivos que se conectan a los puertos de expansión \textsc{pci} de una placa base convencional, tras el montaje del periférico los conectores de que dispone quedan expuestos en la parte trasera de la carcasa en la que de manera providencial debe encontrarse instalada la placa.\par
Las tablas y figuras dispuestas (disposición)
