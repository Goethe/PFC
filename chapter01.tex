...
Como se ha explicado en la \vref{sec:goals} uno de los objetivos que ha perseguido este proyecto de fin de carrera es el de implementar un sistema de adquisición y procesado de señales con el que llevar a cabo la segunda parte del mismo, la experimentación en palmeras mediante \textsc{endus}. Esta parte del documento trata el desarrollo de un sistema como tal. El protagonismo que tiene la tarjeta de adquisición de señales en el sistema de adquisición justifica que se dedique un apartado a dar una descripción técnica de este dispositivo.\par
Para desarrollar un sistema de adquisición y procesado de señales es necesario en primer término un dispositivo que permita realizar la adquisición de la señal. Con tal propósito se dispuso al iniciar el proyecto de una \kpci{} fabricada por \emph{Keithley}. En parte es debido a que se tiene acceso a este dispositivo por lo que se opta por desarrollar un sistema de adquisición de señales propio. Para comprender las posibilidades que proporciona una tarjeta de estas características se necesita una descripción técnica de la misma. En esta descripción técnica se exponen a continuación las características técnicas de la tarjeta, después pasa a darse una descripción funcional de la misma y se concluye explicando las posibilidades de conectividad. Un ulterior apartado proporciona una descripción del proceso de desarrollo de una nueva interfaz para facilitar la experimentación con la tarjeta. % NOTAS (SI YA NO TE SIRVEN, BÓRRALAS): Lo primero es decir que el primer paso que se dio durante la ejecución del proyecto es estudiar la tarjeta para ver que se podía hacer con ella. Se sintetizan un poco esas posibilidades en este capítulo mediante una descripción técnica. La descripción técnica que se expone en esta memoria consta de un listado de las características técnicas del dispositivo, la descripción funcional del mismo, y un apartado que expone las posibilidades en términos de conectividad que ofrece.
