...
BBL = $(TEXMAIN:.tex=.bbl)
TEXMAIN = gis-pfc.tex
TEX = gis-pfc-pro.tex gis-pfc-part1.tex gis-pfc-ch1.tex gis-pfc-ch2.tex \
	gis-pfc-ch3.tex gis-pfc-ch4.tex gis-pfc-part2.tex gis-pfc-ch5.tex \
	gis-pfc-appa.tex gis-pfc-appb.tex
BIB = $(TEXMAIN:.tex=.bib)
