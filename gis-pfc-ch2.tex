...
\begin{figure}
	\begin{center}
		\includegraphics{gis-pfc-ch2-7.mps}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics{gis-pfc-ch2-8.mps}
	\end{center}
...
\begin{lstlisting}[style=displayed, caption={Configuración de \emph{callback} para responder a eventos en la sesión de muestreo, la función de \emph{callback} recibe un argumento.}, label={cod:callback}]
