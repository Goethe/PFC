...
\newcommand\texto{Este manual está destinado a todo aquel usuario
interesado en la representación de señales eléctricas en el contexto que se
ha expuesto anteriormente en el libro. En concreto, puede ser de especial
interés para aquellos usuarios que deseen representar el espectro en
frecuencia de una señal eléctrica en tiempo real, de forma que al mismo
tiempo pueda visualizarse la señal correspondiente a dicho espectro.}
...
\begin{figure}
	\begin{center}
		\includegraphics[angle=90]{gis-pfc-ch1-05.pdf}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics{gis-pfc-ch1-06.pdf}
	\end{center}
...
% \newsavebox{\txbox}
% \sbox{\txbox}{\includegraphics[draft=true]{gis-pfc-ch5-07.pdf}}
% \newsavebox{\gxbox}
% \sbox{\gxbox}{\includegraphics[draft=true]{palm-trees-01.pdf}}
% \newlength{\txwidth}
