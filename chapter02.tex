...
La consecuencia directa de emplear la \kpci{} como instrumento principal en la adquisición de señales analógicas en contraposición con un dispositivo de adquisición autónomo que no tenga la necesidad de un \textsc{pc} que lo gobierne, es la necesidad de un software de control que se ocupe entre otras de las siguientes tareas:

\begin{itemize}
	\item Iniciar y detener la sesión de adquisición.
	\item Interactuar con los drivers de la tarjeta para controlar por voluntad del usuario parámetros de la sesión de adquisición como pueden ser, por ejemplo, puertos de entrada, modos de adquisición y terminación, frecuencia de muestreo.
	\item Hacer el mantenimiento de los buffers de la tarjeta de adquisición. Tarea que incluye dar formato a las muestras almacenadas en el o los buffers y trasladar las mismas a la memoria secundaria del \textsc{pc} para que de ese modo puedan ser posteriormente manipuladas.
\end{itemize}

Puesto que la aplicación de control es necesaria y lo es también el esfuerzo necesario para realizarla se decide con anterioridad al proceso de creación diseñar el software de forma que pueda desarrollar competencias adicionales. Así, además de las tareas básicas el software de control se diseña para que pueda cumplir con los siguientes cometidos.
