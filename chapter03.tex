...
\begin{table}[htbp]
	...
	\begin{tabular}{l >{\tt\qquad}l}
		...
		\bottomrule
	\end{tabular}
	\caption{Nombre de adaptador que debe emplearse en la llamada a \texttt{analoginput} en función del fabricante}
	\label{tab:adaptors}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabulary}{.9\linewidth}{>{\sf}c L}
		...
		\midrule
		Reloj interno\tnote{a} & Por añadidura, la \kpci{} cuenta con la posibilidad de recibir el disparo de la fuente de reloj interna. \\
		\bottomrule
	\end{tabulary}
	\begin{TableNotes}
