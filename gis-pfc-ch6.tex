...
\begin{figure}
    \begin{center}
	\subfloat[Palmera de unos $5.5$ m de alto][]{
	    \begin{minipage}[c]{.425\textwidth}\label{fig:testheight}
		\centering
		\includegraphics{gis-pfc-ch6-05.jpg}
	    \end{minipage}}
	\subfloat[Fotografía de parte del equipo de medida utilizado.][]{
...
\begin{figure}[tp]
    ...
    \end{center}
    \caption[Desplazamiento del máximo frecuencial, en madera de
...
\begin{figure}[bp]
    ...
    \end{center}
    \caption[Desplazamiento del máximo frecuencial, en madera de
    pino]{Desplazamiento del máximo frecuencial observado en la onda
    recibida al emitir un pulso ultrasónico en un pino (\atr{Pin}).}
    \label{fig:Afpino}
\end{figure}
