...
El propósito habitual de una memoria de proyecto fin de carrera es el de
...
de los mismos y apuntar las conclusiones que se han alcanzado a partir de
dicho estudio. Sin embargo, es habitual que un proyecto fin de carrera
produzca resultados que van más allá del contexto marcado por el tema
original del proyecto. Este es el caso del sistema de medida digital y de
la aplicación de control en el contexto de este proyecto fin de carrera.

Ahora un par de ideas: el concepto que quiero incluir a continuación en el
párrafo de introducción es el de que el manual/guía de usuario de la
aplicación tiene un interés intrínseco, no relacionado con el resto del
documento (fuera del propósito de la memoria), pero suficiente como para
ser incluido en el mismo. Pero, puesto que no va en la línea del resto de
la memoria se ha adjuntado en forma de apéndice.
...
\begin{itemize}
	...
	\item Es necesaria una interfaz externa compatible con los
		conectores mini-\sig{d} de la \kpci{}. Puede emplearse por
...
\subsection{Limitaciones del software de control}
...
\vrefrange{sec:technical}{sec:throughput} en el segundo capítulo. A
