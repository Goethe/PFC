...
de metales o conglomerados, someter el material a \sig{end} con el fin de
...
Existen principalmente dos motivos por los que los \sig{end} pueden ser más
...
otro lado, los controles de calidad basados en \sig{end} pueden efectuarse
...
pruebas en las que sólo se evalúa parte del material, los ensayos no
...
mantienen uniformes a lo largo del mismo. Además, puesto que los \sig{end}
