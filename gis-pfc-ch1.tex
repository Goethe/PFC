...
medida. Por lo común, la búsqueda de una alternativa específica a un
instrumento de ésta índole no está motivada por una necesidad imperiosa si
no que está promovida por un interés particular en aplicaciones concretas o
...
dispositivo estándar un circuito acondicionador puede ser diseñado, según
la situación lo requiera, para desempeñar una o varias de las funciones
...
en el mismo orden en el que se envían. El \cref{chap:acquisition}
profundiza más en los detalles sobre el funcionamiento de la tarjeta
\kpci{}.} y el ordenador, que asimismo gobierna el funcionamiento del
sistema. Ambas entidades pueden ser consideradas dispositivos estándar de
acuerdo a la definición dada en la introducción a esta sección. De ambos
dispositivos, configurados en cascada, el acondicionador interactúa de
manera directa sólo con la tarjeta de adquisición. Este hecho es relevante
de cara al diseño del circuito pues significa que únicamente depende de las
