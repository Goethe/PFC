...
En aplicaciones prácticas, el denominado circuito acondicionador se emplea
para acomodar la señal que entrega el sensor de modo que tras sufrir una
transformación pueda ser procesada, representada o simplemente almacenada
utilizando para ello instrumentos de carácter estándar. Por lo general un
circuito acondicionador realiza una o varias de las siguientes tareas:

\begin{itemize}
	\item Acotar el recorrido de la señal y confinarlo en unos márgenes
		convenientes, evitando la saturación de etapas posteriores.
	\item Adaptar la impedancia de salida del sensor a la impedancia de
		entrada de la etapa posterior al circuito.
	\item Magnificar la señal de entrada que proporciona el sensor para
		evitar eventuales pérdidas de información en etapas
		subsiguientes.
	\item Aplicar un filtrado para eliminar las componentes de señal
		que el sistema no puede asimilar y que pudieran/son
		susceptibles de causar algún tipo de distorsión.
\end{itemize}

O cualquier otra acción que requiera efectuarse sobre la señal para la
correcta transmisión de ésta y la información que transporta en todo el
sistema.


\subsection{Requisitos de diseño}

% Según las especificaciones del sensor de ultrasonidos este entrega
