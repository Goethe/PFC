...
\begin{align}
	T_H &= C_1\cdot ln(2)(R_1 + R_2) \simeq 0,693C\cdot(R_1 + R_2) \\
	T_L &= C_1\cdot ln(2)(R_2) \simeq 0,693CR_2 \\
	T &= T_H + T_L = C_1\cdot ln(2)(R_1 + 2R_2) = \frac{1}{f} \\
...
\begin{equation}
	T_H = C_2R_3ln(3) \simeq 1,1C_2R_3
	\label{eq:monostable}
\end{equation}
...
un 555 monoestable debe rondar valores elevados y, por tanto, $R_1 \lll
R_2$.
