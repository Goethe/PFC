...
\begin{figure}
	\begin{center}
		\includegraphics[scale=1, keepaspectratio=true]{gis-pfc-ch1-1.mps}
	\end{center}
...
\newsavebox{\auxbox}
\sbox{\auxbox}{\includegraphics[height=.3\textheight, keepaspectratio=true, angle=90]{gis-pfc-ch1-2.pdf}}
\newlength{\auxheight}
...
\begin{figure}
	...
	\subfloat[Conector etiquetado como ``analog'']{\vbox  to \auxheight{ %
		\hbox to \auxwidth{
			\hspace*{-7pt}\includegraphics[height=.3\textheight, keepaspectratio=true, angle=90]{gis-pfc-ch1-2.pdf}} %
	\vfil}}\qquad
	\subfloat[Conector etiquetado como ``digital'']{\vbox to \auxheight{\vfil %
		\hbox to \auxwidth{
			\hspace*{-7pt}\includegraphics[height=.3\textheight, keepaspectratio=true, angle=90]{gis-pfc-ch1-3.pdf}} %
	\vfil}}
...
\begin{figure}
	\begin{center}
		\includegraphics{gis-pfc-ch1-4.jpg}
	\end{center}
...
% \begin{figure}
% 	\begin{center}
% 		\includegraphics{gis-pfc-ch1-5.pdf}
% 	\end{center}
