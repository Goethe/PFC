...
\usepackage{hyperref, ifthen,   layouts,  listings, rotating, textcase}
...
%--------------------------------hyperref---------------------------------%
\hypersetup{
	pdftitle           = Diseño e implementación de un sistema de
			     medida digital y ensayos no destructivos
			     mediante ultrasonidos en madera de palmera,
...
\selectbiblanguage{spanish}					% babelbib
...
\makeatletter\renewcommand\@pnumwidth{21.5pt}\makeatother	% pnumwidth
...
\bibliographystyle{bababbrv-lf}					% babelbib
