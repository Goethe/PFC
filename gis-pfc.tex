...
\usepackage{ifthen, layouts, listings, textcase, textcomp}
...
% 	{\small\scshape\filleft}{\thesubsubsection}{\margiparsep}{}
% \titleformat{name=\subsubsection,page=odd}[rightmargin]%
% 	{\small\scshape\filright}{\thesubsubsection}{\margiparsep}{}
% \titleformat{\subparagraph}[runin]{\bfseries\itshape}{\thesubparagraph}%
% 	{1em}{}
% \titlespacing*{\subsubsection}{\marginparwidth}{0pt}{\marginparsep}
...
\setlength\marginparwidth{\pdfpagewidth - \textwidth - \oddsidemargin - %
	2\marginparsep - 1in}
% Se aplica el siguiente convenio tipográfico a la primera aparición de
% una sigla.
...
% Se aplica el siguiente convenio a argumentos de función distintos de
% propiedades.
