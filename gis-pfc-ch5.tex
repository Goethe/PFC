	...
	\begin{center}
		\subfloat[Inspección ultrasónica por transmisión]{
			\begin{minipage}{.9\textwidth}
				\centering\includegraphics{gis-pfc-ch5-02.mps}
			\end{minipage}}
			\vspace*{.1\textheight}
		\subfloat[Inspección ultrasónica por pulso"=eco]{
			\begin{minipage}{.9\textwidth}
				\centering\includegraphics{gis-pfc-ch5-03.mps}
			\end{minipage}}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=1, keepaspectratio=true]{gis-pfc-ch5-04.mps}
	\end{center}
...
Donde, como se anticipó en \eqref{eq:loss}, $\alpha(\omega)$ es el coeficiente de atenuación.\par
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=1, keepaspectratio=true]{gis-pfc-ch5-05.mps}
	\end{center}
...
El procedimiento (más detallado en el \cref{tab:sspfeatures}) que por lo general sigue todo el conjunto de técnicas de \sig{ssp} consiste en aplicar una transformación sobre la traza que comprende dos pasos:
...
\begin{table}
	...
	\begin{tabulary}{.95\textwidth}{>{$(}c<{)$}Lr@{\hspace{6pt}}L}
		...
		\Delta f & Separación entre filtros & 4. & Calcular la \sig{ifft} de las trazas de banda estrecha \\
		...
		\bottomrule
	\end{tabulary}
	\caption[Particularidades que en general se aplican a todos los algoritmos de \sig{ssp}]{Particularidades que en general se aplican a todos los algoritmos de \sig{ssp}.}
