...
\begin{table}
	...
	f_\text{min} & Frecuencia inferior de corte del banco de filtros &
	2. & Calcular la \sig{fft} de $y$ \\
	f_\text{max} & Frecuencia superior de corte del banco de filtros &
	3. & Procesar el resultado obtenido en (2) con el banco de
	filtros \\
	\Delta f & Separación entre filtros & 4. & Calcular la \sig{ifft}
    ...
    algoritmos de \sig{ssp}.\\\emph{Fuente:} \citet{garcia2000mrsr}.}
...
técnica de \sig{ssp}. Señala M.\,A. García que, a pesar de que la
