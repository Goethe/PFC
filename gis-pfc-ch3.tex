...
Este capítulo se ha dispuesto de modo que en lugar de explicar línea a
línea el significado del código correspondiente al software de control se
hace en primer lugar, en el apartado siguiente, una completa descripción de
la interfaz sobre la que se ha construido el código y que, en definitiva,
marca todos los aspectos relacionados con el desarrollo del software; para
pasa a exponer, a continuación, los objetivos impuestos en la etapa de
diseño. De modo que el lector pueda figurarse cual debe ser el resultado
final y como se debe haber alcanzado.
...
\section{Herramienta de Adquisición de Datos de \textsc{matlab}}


\subsection{Introducción}

\psig{matlab} (\emph{LABoratorio MATemático}) es la plataforma seleccionada
...
implementa la mayor parte de lo que se entiende como bloque de control.	Es
por este motivo por el que la \datx{} supone una pieza fundamental del
software de control y, por consiguiente, adquiere vital importancia en el
subsistema de control y presentación y por ende en el sistema de medida
digital. Consecuentemente, se proporciona en este apartado una breve
descripción de los distintos elementos que conforman esta herramienta y un
compendio de las funciones que pone a disposición del desarrollador
ordenadas siguiendo el mismo orden en el que se utilizan durante una sesión
de adquisición básica.
