...
Las tareas correspondientes al bloque de control que debe desempeñar el software son las siguientes:
...
Por otro lado se encuentran las funciones que debe proveer el bloque de presentación, cuyo objetivo no es otro que mostrar información de utilidad al supervisor a partir de la señal digital obtenida del subsistema de adquisición.
